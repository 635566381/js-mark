(function (global, factory) {
    ...
    function getTextNodes(node, ignoreClass = [], ignore = false) {
        var _a, _b;
        let textNodes = [];
        ...
        for (let i = 0; i < e.length; i++) {
            ...
            if (element.nodeType === NodeTypes.TEXT_NODE && ((_a = element.parentElement) === null || _a === void 0 ? void 0 : _a.nodeName) !== "SCRIPT" && ((_b = element.textContent) === null || _b === void 0 ? void 0 : _b.trim()) !== "") {
    ...
    **/
    ...
    let vTextNodes = [];
    function initVTextNodes(textNodes) {
        let offset = 0;
        vTextNodes = [];
    ...
    function splitVTextNode(text, offset) {
        ...
        if (i !== -1) {
            ...
            const newVText = {
                ...
                offset: vTextNodes[i].offset + (((_a = vTextNodes[i].text.textContent) === null || _a === void 0 ? void 0 : _a.length) || 0)
            };
    ...
    function sliceVTextNode(startText, endText, hasIgnore = false) {
    ...
    function getOptionalVText(vTextNode) {
    ...
    class JsMark {
        constructor(ops) {
            ...
            initVTextNodes(getTextNodes(ele, config.ignoreClass));
        ...
        _setEleNoSelect(ele, classNames) {
            classNames.map(item => {
        ...
        _captureSelection(range) {
            ...
            let text = "";
            textNodes === null || textNodes === void 0 ? void 0 : textNodes.map(item => text += item.textContent);
            this._onSelected({
                text,
                offset,
        ...
        _removeMark(eleS) {
            ...
            initVTextNodes(getTextNodes(this._element, config.ignoreClass));
        }
        beautifyHTML() {
